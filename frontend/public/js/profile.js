...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Robust check for both token and user existence, handling "undefined" string edge cases
  const isValidToken = token && token !== 'undefined' && token !== 'null';
  const isValidUser = userStr && userStr !== 'undefined' && userStr !== 'null';
  ...
  if (user.profile_picture) {
    profileImg.src = getImgPath(user.profile_picture);
